              ...
              >
                <div className="text-center">
                  ...
                  <button 
                    ...
                    className={`w-full bg-gradient-to-r ${platform.gradient} text-white py-2 px-3 md:px-4 rounded-full text-xs md:text-sm font-medium transition-all duration-300 hover:scale-110 hover:shadow-2xl relative overflow-hidden group/button before:absolute before:inset-0 before:bg-white/20 before:translate-y-full hover:before:translate-y-0 before:transition-transform before:duration-300 cursor-pointer`}
