          ...
          <div className="mb-6 md:mb-8" data-aos="zoom-in" data-aos-duration="500">
            <div className="relative inline-block">
              ...
              <img 
                ...
                alt={displayName}
                loading="eager"
                className="w-32 h-32 sm:w-40 sm:h-40 md:w-48 md:h-48 lg:w-56 lg:h-56 rounded-full border-4 border-neon-purple animate-pulse-glow transition-all duration-500 ease-in-out hover:scale-110 hover:rotate-3 hover:shadow-[0_0_60px_rgba(168,85,247,0.8)]"
